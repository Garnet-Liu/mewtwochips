...
export default function WagmiSend() {
  ...
  return (
    <form className="w-80 my-5" onSubmit={handleSubmit(onSubmit)}>
      ...
      <p id={passwordHintId} className="h-7 pt-1 text-left">{formState?.errors?.count && <span>This field is required</span>}</p>
