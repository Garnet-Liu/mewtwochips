...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  ...
  Stats: ( Omit<PokemonStats, 'name_id'> & { name_id?: Maybe<_RefType['StatsType']> } & { __typename: 'PokemonStats' } );
}>;
...
export type ResolversTypes = ResolversObject<{
  ...
  Pokemon: ResolverTypeWrapper<Omit<Pokemon, 'stats'> & { stats?: Maybe<Array<Maybe<ResolversTypes['PokemonStats']>>> }>;
  Int: ResolverTypeWrapper<Scalars['Int']['output']>;
  PokemonAbilities: ResolverTypeWrapper<PokemonAbilities>;
  PokemonImages: ResolverTypeWrapper<PokemonImages>;
  PokemonPage: ResolverTypeWrapper<Omit<PokemonPage, 'results'> & { results?: Maybe<Array<Maybe<ResolversTypes['Pokemon']>>> }>;
  PokemonStats: ResolverTypeWrapper<Omit<PokemonStats, 'name_id'> & { name_id?: Maybe<ResolversTypes['StatsType']> }>;
  Query: ResolverTypeWrapper<{}>;
  Stats: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['Stats']>;
  StatsType: ResolverTypeWrapper<'HP' | 'ATTACK' | 'DEFENSE' | 'SPECIAL_ATTACK' | 'SPECIAL_DEFENSE' | 'SPEED'>;
}>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Pokemon: Omit<Pokemon, 'stats'> & { stats?: Maybe<Array<Maybe<ResolversParentTypes['PokemonStats']>>> };
  Int: Scalars['Int']['output'];
  PokemonAbilities: PokemonAbilities;
  PokemonImages: PokemonImages;
  PokemonPage: Omit<PokemonPage, 'results'> & { results?: Maybe<Array<Maybe<ResolversParentTypes['Pokemon']>>> };
...
export type AbilitiesResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Abilities'] = ResolversParentTypes['Abilities']> = ResolversObject<{
...
export type PokemonResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Pokemon'] = ResolversParentTypes['Pokemon']> = ResolversObject<{
  abilities?: Resolver<Maybe<Array<Maybe<ResolversTypes['PokemonAbilities']>>>, ParentType, ContextType>;
...
export type PokemonAbilitiesResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['PokemonAbilities'] = ResolversParentTypes['PokemonAbilities']> = ResolversObject<{
  entries?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
...
export type PokemonImagesResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['PokemonImages'] = ResolversParentTypes['PokemonImages']> = ResolversObject<{
...
export type PokemonPageResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['PokemonPage'] = ResolversParentTypes['PokemonPage']> = ResolversObject<{
...
export type PokemonStatsResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['PokemonStats'] = ResolversParentTypes['PokemonStats']> = ResolversObject<{
...
export type QueryResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  pokemonAll?: Resolver<Maybe<ResolversTypes['PokemonPage']>, ParentType, ContextType, RequireFields<QuerypokemonAllArgs, 'limit' | 'offset'>>;
}>;

export type StatsResolvers<ContextType = MyContext, ParentType extends ResolversParentTypes['Stats'] = ResolversParentTypes['Stats']> = ResolversObject<{
...
export type StatsTypeResolvers = EnumResolverSignature<{ ATTACK?: any, DEFENSE?: any, HP?: any, SPECIAL_ATTACK?: any, SPECIAL_DEFENSE?: any, SPEED?: any }, ResolversTypes['StatsType']>;
